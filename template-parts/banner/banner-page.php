<?php 
  ...
  * Display page banner 
  */
$show_banner = fabio_opt('page_banner_toggle', 'show');
$show_banner_in_page = fabio_page_meta('is_banner', get_the_ID(), 1);

$banner_url = fabio_opt('page_banner_img_upload');
$banner_url_page= fabio_page_meta('banner_background_image', get_the_ID());  

$how_title = fabio_opt('page_banner_title', 'show');
$show_breadcrumbs = fabio_opt('page_banner_breadcrumb', 'show');
