...
$is_banner = fabio_opt('error_banner_toggle', 'show');
$is_banner_title = fabio_opt('is_error_banner_title', 'show');
$banner_title = fabio_opt('error_banner_title', '404');
  
$banner_url = fabio_opt('error_banner_img_upload');
$show_breadcrumbs = fabio_opt('error_banner_breadcrumb', 'show');
