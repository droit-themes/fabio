<?php 
  ...
  * Display page banner 
  */
$show_banner = fabio_opt('shop_banner_toggle', 'show');
$show_banner_in_page = fabio_page_meta('is_banner', get_the_ID(), 1);

$banner_url = fabio_opt('shop_banner_img_upload');
$banner_url_page= fabio_page_meta('banner_background_image', get_the_ID());  

$show_title = fabio_opt('is_shop_banner_title', 'show');
$shop_banner_title = fabio_opt('shop_banner_title', 'Shop Page');

$shop_single_banner_title = fabio_opt('shop_single_banner_title', 'Product Details');

$show_breadcrumbs = fabio_opt('shop_banner_breadcrumb', 'show');

$banner_background_url = fabio_IMAGES.'/woocommerce/banner/banner.png';
