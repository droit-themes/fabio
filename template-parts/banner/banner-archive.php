...
$is_banner = fabio_opt('archive_banner_toggle', 'show');
$is_breadcrumbs = fabio_opt('archive_banner_breadcrumb', 'show');
$is_banner_title = fabio_opt('is_archive_title', 'show');
$banner_url = fabio_opt('archive_banner_img_upload');
