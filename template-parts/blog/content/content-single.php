 ...
 */
$show_social_share = fabio_opt('display_blog_share', 'no');
    ...
    <div class="media_blog_content">
      <?php  if(has_post_thumbnail( )) {  ?>
        ...
        <?php the_content();
            ...
            wp_link_pages(
                array(
                    'before'   => '<nav class="page-links" aria-label="' . esc_attr__( 'Page', 'fabio' ) . '">',
                    'after'    => '</nav>',
                    /* translators: %: page number. */
                    'pagelink' => esc_html__( 'Page %', 'fabio' ),
                )
            );
