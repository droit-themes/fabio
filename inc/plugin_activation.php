...
add_action( 'tgmpa_register', 'fabio_resister_required_plugin' );
/**
 ...
 */
function fabio_resister_required_plugin() {
    /*
    ...
    $plugins = array(
        ...
        array(
            'name'      => esc_html__( 'Elementor', 'fabio' ),
            'slug'      => 'elementor',
            'required'  => true,
        ),
        ...
        array(
            'name'               => esc_html__( 'Redux Framework', 'fabio' ),
            'slug'               => 'redux-framework',
            'required'           => true,
        ),

        array(
            'name'      => esc_html__( 'Contact Form 7', 'fabio' ),
            'slug'      => 'contact-form-7',
            'required'  => true,
        ),

        array(
            'name'      => esc_html__( 'One Click Demo Import', 'fabio' ),
