...
function fabio_scripts() {
  ...
  if(is_page_template('one_page.php')){
	...
	wp_enqueue_style( 'fabio-one-bootstrap', get_theme_file_uri('/assets/css/onepage/bootstrap.min.css'), array(), fabio_VERSION );
	...
	wp_enqueue_style( 'fabio-woocommerce', fabio_CSS . '/woocommerce.min.css' );
