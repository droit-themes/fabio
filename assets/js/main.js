...
jQuery(function () {
 ...
 function QuantityChange() {
	$(document).off("click", "._fabio_quntity_changer > button").on("click", "._fabio_quntity_changer > button", function () {
		// Find quantity input field corresponding to increment button clicked.
		var qty = $(this).parents('._fabio_quntity_changer').siblings('.input-text');
		console.log(qty);
